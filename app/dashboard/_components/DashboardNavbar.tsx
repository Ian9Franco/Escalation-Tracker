...
export function DashboardNavbar({
  ...
  return (
    <nav className="flex justify-between items-center mb-16 card-widget p-5 bg-card/10 backdrop-blur-xl border-white/5 relative z-[100]" style={{ overflow: 'visible' }}>
