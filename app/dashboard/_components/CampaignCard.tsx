    ...
    <div className={`card-widget p-8 transition-all group flex flex-col justify-between relative bg-card border-beam-container ${beamStatusClass} ${isPaused ? 'opacity-60 grayscale-[0.5]' : ''} ${isFinished ? 'border-success/30' : ''} reveal`}>
        ...
        <div className="space-y-1">
          ...
          <div className="flex gap-2 items-center">
            <span className={`text-[9px] font-black px-2 py-0.5 rounded-full border ${
              isFinished ? 'bg-success/10 text-success border-success/20' : 
      ...
      <div className="flex flex-col sm:flex-row sm:justify-between gap-6 mb-8">
        <div className="space-y-1 min-w-0 flex-1">
          ...
          <p className="text-xl font-black text-foreground tabular-nums tracking-tighter truncate" title={formatCurrency(currentBudget)}>{formatCurrency(currentBudget)}</p>
        </div>
